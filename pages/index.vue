...
.jumbotron {
  background-image: url("../assets/satiweb_bg.jpg");
...
.backside .card2 a {
  font-size: 18px;
  color: #97d6ed !important;
}

.frontside .card2 .card-title,
.backside .card2 .card-title {
  color: black !important;
}

.frontside .card2 .card-body img {
  width: 100px;
  height: 100px;
  border-radius: 60%;
}
...
#contact .card3:hover i,
#contact .card3:hover h4 {
  color: #007b5e;
}
